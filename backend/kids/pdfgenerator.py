...
def generate_night_permission_pdf(users,code):
    buffer = io.BytesIO()
    ...
    def add_page_template(canvas, doc):
        ...
        canvas.drawString(60, 350 + 90, "Respected Sir,")
        canvas.drawString(75, 320 + 100, f"The following students were working late at CTC on {today_date} Till 11:30 PM.")
        canvas.drawString(75, 300 + 105, "Kindly permit them to enter the hostel.")
